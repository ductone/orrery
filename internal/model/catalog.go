...
var Catalog = []ModelSpec{
	...
	{ID: "together/deepseek-ai/DeepSeek-V4-Flash-0731", Family: DeepSeek, Tier: Efficient, Inputs: []Modality{Text}, ContextWindow: 1048576, MaxOutput: 128000, Pricing: Pricing{Input: .14, Output: .28, CacheRead: .03}, Effort: []Effort{EffortHigh}, Compat: Compat{MaxTokensField: "max_tokens", SupportsToolChoice: true, SupportsReasoningEffort: true, EffortWireMap: map[Effort]string{EffortHigh: "high"}, RequiresReasoningEcho: true, RequiresAssistantText: true, StreamIdleTimeout: 15 * time.Minute, SystemPromptStyle: SystemTopLevel}, EditDialect: HashlineJSON},
